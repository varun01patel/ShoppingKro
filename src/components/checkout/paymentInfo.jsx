    ...
    return (
        <>
            <div>
                ...
                <p className="text-muted text-truncate mb-4">Select Payment Method</p>
            </div>
            {/* <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="accordion" id="accordionPayment">
                            ...
                            <div class="accordion-item mb-3 border">
                                <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                                    <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#" aria-expanded="false">
